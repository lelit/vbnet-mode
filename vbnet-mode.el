...
;; Last-saved : <2018-October-06 11:31:22>
...
;;
;; 1.6a Lele changes October 2018
;;
;;      Added "protected" keyword variants.
;;
...
(eval-and-compile
  (defvar vbnet-all-keywords
    '("Add" "Aggregate" "And" "App" "AppActivate" "Application" "Array" "As"
      ...
      "Or" "PPmt" "PV" "Parameter" "Parameters" "Partial" "Partition"
  ...
  (let ((original-point (point)))
    (save-excursion
      ...
      (cond
       ...
       ;; ASP directives, always at bol
       ((or (looking-at (vbnet-regexp 'asp-directive))
            (looking-at (vbnet-regexp 'asp-script-start-tag))
            (looking-at (vbnet-regexp 'asp-script-end-tag)))
        0)
